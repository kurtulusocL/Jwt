...
using AuthProjectJWT.Core.Utilities.Security.Hashing;
...
namespace AuthProjectJWT.Business.Conctere
{
    public class AuthManager:IAuthService
    {
        ...
        public IDataResult<User> Register(UserRegister userForRegisterDto, string password)
        {
        ...
        public IDataResult<User> Login(UserLogin userForLoginDto)
        {
